...
{
    /// <summary>
    /// Names of roles that can be used for RBAC purposes
    /// </summary>
    /// <remarks>
    ///     This list is identical to the <see cref="EnumActorTypes"/> enumeration on purpose.
    /// </remarks>
    [Flags]
    [JsonConverter(typeof(JsonStringEnumConverter))]
    public enum EnumRbacRoleNames
    {
        /// <summary>
