...
// Implementation of WITH and TOP clauses.
public sealed partial class SqlUpdateBuilder
{
    ...
    public SqlUpdateBuilder Top(uint count, bool isPercent = false)
    {
        if (_topN.HasValue)
        {
    ...
    public SqlUpdateBuilder With(SqlHint hints)
    {
        base.AppendHints(hints, SqlStatementType.Update);
        return this;
    }
