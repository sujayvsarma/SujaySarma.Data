...
public sealed partial class SqlUpdateBuilder
{
    ...
    public SqlUpdateBuilder InnerJoin<TLeft, TRight>(Expression<Func<TLeft, TRight, bool>> joinCondition, SqlHint joinHints)
    {
    ...
    /// <param name="joinHints">SQL Hints for the JOIN clause (only those that apply to SELECT are valid here!).</param>
    /// <returns>Instance of self.</returns>
    public SqlUpdateBuilder LeftJoin<TLeft, TRight>(Expression<Func<TLeft, TRight, bool>> joinCondition, SqlHint joinHints)
    {
        base.ResolveType(typeof(TLeft));
        base.ResolveType(typeof(TRight));
    ...
    /// <param name="joinHints">SQL Hints for the JOIN clause (only those that apply to SELECT are valid here!).</param>
    /// <returns>Instance of self.</returns>
    public SqlUpdateBuilder RightJoin<TLeft, TRight>(Expression<Func<TLeft, TRight, bool>> joinCondition, SqlHint joinHints)
    {
        base.ResolveType(typeof(TLeft));
        base.ResolveType(typeof(TRight));
    ...
    /// <param name="joinHints">SQL Hints for the JOIN clause (only those that apply to SELECT are valid here!).</param>
    /// <returns>Instance of self.</returns>
    public SqlUpdateBuilder FullJoin<TLeft, TRight>(Expression<Func<TLeft, TRight, bool>> joinCondition, SqlHint joinHints)
    {
        base.ResolveType(typeof(TLeft));
        base.ResolveType(typeof(TRight));
    ...
    /// <param name="joinHints">SQL Hints for the JOIN clause (only those that apply to SELECT are valid here!).</param>
    /// <returns>Instance of self.</returns>
    public SqlUpdateBuilder CrossJoin<TLeft, TRight>(SqlHint joinHints)
    {
        base.ResolveType(typeof(TLeft));
        base.ResolveType(typeof(TRight));
