...
namespace SujaySarma.Data.SqlServer.Builders
{
    ...
    internal class SqlLambdaVisitor : ExpressionVisitor
    {
        ...
        public string Tour(Expression expression, bool treatAssignmentsAsAlias = false)
        {
        ...
        protected override Expression VisitMember(MemberExpression node)
        {
            ...
            string? tableAliasOrName = _typeTableAliasMap.GetUsableMoniker(node.Member.DeclaringType);
            if (string.IsNullOrWhiteSpace(tableAliasOrName))
            {
                ...
                if (memberType.IsGenericType)
                {
                    ...
                    foreach (Type genericArgumentType in genericArguments)
                    {
                        ...
                        {
                            tableAliasOrName = _typeTableAliasMap.GetUsableMoniker(genericArgumentType);
                            break;
                        }
                    }
                }
        ...
        public SqlLambdaVisitor(ClrToTableWithAliasCollection typeTableMap)
            : base()
        {
        ...
        private readonly ClrToTableWithAliasCollection _typeTableAliasMap = new ClrToTableWithAliasCollection();
