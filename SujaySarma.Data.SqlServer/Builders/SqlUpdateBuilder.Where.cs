...
public sealed partial class SqlUpdateBuilder
{
    ...
    public SqlUpdateBuilder AndWhere<TTable>(Expression<Func<TTable, bool>> condition)
    {
        if (_where is null)
        {
    ...
    /// <param name="condition">The condition.</param>
    /// <returns>Instance of self.</returns>
    public SqlUpdateBuilder AndWhere<TTable1, TTable2>(Expression<Func<TTable1, TTable2, bool>> condition)
    {
        if (_where is null)
        {
            throw new InvalidOperationException("WHERE clause has not been initialized. Use Where() to add the first condition.");
    ...
    /// <param name="condition">The condition.</param>
    /// <returns>Instance of self.</returns>
    public SqlUpdateBuilder OrWhere<TTable>(Expression<Func<TTable, bool>> condition)
    {
        if (_where is null)
        {
            throw new InvalidOperationException("WHERE clause has not been initialized. Use Where() to add the first condition.");
    ...
    /// <param name="condition">The condition.</param>
    /// <returns>Instance of self.</returns>
    public SqlUpdateBuilder OrWhere<TTable1, TTable2>(Expression<Func<TTable1, TTable2, bool>> condition)
    {
        if (_where is null)
        {
            throw new InvalidOperationException("WHERE clause has not been initialized. Use Where() to add the first condition.");
    ...
    /// <param name="condition">The condition.</param>
    /// <returns>Instance of self.</returns>
    public SqlUpdateBuilder Where<TTable>(Expression<Func<TTable, bool>> condition)
    {
    ...
    /// <param name="condition">The condition.</param>
    /// <returns>Instance of self.</returns>
    public SqlUpdateBuilder Where<TTable1, TTable2>(Expression<Func<TTable1, TTable2, bool>> condition)
    {
        if (_where is not null)
        {
            throw new InvalidOperationException("WHERE clause has already been initialized. Use AndWhere() or OrWhere() to add more conditions.");
