...
public sealed partial class SqlDeleteBuilder
{
    ...
    public SqlDeleteBuilder AndWhere<TTable>(Expression<Func<TTable, bool>> condition)
    {
        if (_where is null)
        {
    ...
    /// <param name="condition">The condition.</param>
    /// <returns>Instance of self.</returns>
    public SqlDeleteBuilder AndWhere<TTable1, TTable2>(Expression<Func<TTable1, TTable2, bool>> condition)
    {
        if (_where is null)
        {
            throw new InvalidOperationException("WHERE clause has not been initialized. Use Where() to add the first condition.");
    ...
    /// <param name="condition">The condition.</param>
    /// <returns>Instance of self.</returns>
    public SqlDeleteBuilder OrWhere<TTable>(Expression<Func<TTable, bool>> condition)
    {
        if (_where is null)
        {
            throw new InvalidOperationException("WHERE clause has not been initialized. Use Where() to add the first condition.");
    ...
    /// <param name="condition">The condition.</param>
    /// <returns>Instance of self.</returns>
    public SqlDeleteBuilder OrWhere<TTable1, TTable2>(Expression<Func<TTable1, TTable2, bool>> condition)
    {
        if (_where is null)
        {
            throw new InvalidOperationException("WHERE clause has not been initialized. Use Where() to add the first condition.");
    ...
    /// <param name="condition">The condition.</param>
    /// <returns>Instance of self.</returns>
    public SqlDeleteBuilder Where<TTable>(Expression<Func<TTable, bool>> condition)
    {
    ...
    /// <param name="condition">The condition.</param>
    /// <returns>Instance of self.</returns>
    public SqlDeleteBuilder Where<TTable1, TTable2>(Expression<Func<TTable1, TTable2, bool>> condition)
    {
        if (_where is not null)
        {
            throw new InvalidOperationException("WHERE clause has already been initialized. Use AndWhere() or OrWhere() to add more conditions.");
