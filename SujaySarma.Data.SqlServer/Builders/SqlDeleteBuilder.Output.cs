...
public sealed partial class SqlDeleteBuilder
{
    ...
    public SqlDeleteBuilder Output<TTable>(Expression<Func<TTable, object>>? columnSelector = null)
    {
        if (_output is null)
        {
    ...
    /// <summary>
    /// Creates or appends an OUTPUT clause that outputs all columns from the DELETED table.
    /// </summary>
    /// <returns>Instance of self.</returns>
    public SqlDeleteBuilder OutputDeleted()
    {
        if (_output is null)
        {
            _output = SqlOutput.WithAllColumns(SqlOutput.EphermeralTableName.DELETED);
        }
        else
        {
            _output.AddAllColumns(SqlOutput.EphermeralTableName.DELETED);
        }
    ...
    /// <summary>
    /// Creates or appends an OUTPUT clause that outputs the specified columns from the DELETED table.
    /// </summary>
    ...
    /// <returns>Instance of self.</returns>
    public SqlDeleteBuilder OutputDeleted(params IEnumerable<string> columnNames)
    {
        if (_output is null)
        {
            _output = SqlOutput.WithColumns(SqlOutput.EphermeralTableName.DELETED, columnNames);
        }
        else
        {
            _output.AddColumns(SqlOutput.EphermeralTableName.DELETED, columnNames);
        }
    ...
    /// <returns>Instance of self.</returns>
    public SqlDeleteBuilder OutputDeleted(Dictionary<string, string> columnNamesWithAliases)
    {
        if (_output is null)
        {
    ...
    /// <returns>Instance of self.</returns>
    public SqlDeleteBuilder OutputToTable<TOutputTable>()
    {
        if (_output is null)
        {
    ...
    public SqlDeleteBuilder OutputToTable(string tableName)
    {
        if (_output is null)
        {
            throw new InvalidOperationException("Set the output columns before specifying an output table.");
