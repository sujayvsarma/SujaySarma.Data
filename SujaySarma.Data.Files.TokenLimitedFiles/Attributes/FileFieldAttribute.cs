...
namespace SujaySarma.Data.Files.TokenLimitedFiles.Attributes
{
    ...
    public sealed class FileFieldAttribute : ContainerMemberAttribute
    {
        ...
        /// </summary>
        public FieldAddressingStrategy AddressingPreference
        {
            get; set;

        } = FieldAddressingStrategy.Name;
        ...
        } = WellknownValuesCollections.TrueValues.ToArray();
        ...
        } = WellknownValuesCollections.FalseValues.ToArray();
        ...
        {
            return AddressingPreference switch
            {
                FieldAddressingStrategy.Name => Name,
                FieldAddressingStrategy.Indices => $"Column {ColumnIndex}"
            };
        }
