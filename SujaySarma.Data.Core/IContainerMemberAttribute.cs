...
namespace SujaySarma.Data.Core
{
    ...
    public interface IContainerMemberAttribute
    {
        ...
        /// </summary>
        DataModificationInclusionBehaviour IncludeInDataModificationOperation { get; set; }
        ...
        /// </summary>
        EnumSerializationBehaviour EnumSerializationStrategy { get; set; }
        ...
        /// </summary>
        bool AllowSerializationAsJson { get; set; }
