...
namespace SujaySarma.Data.Core
{
    ...
    /// </summary>
    /// <remarks>
    ///     This is a simple implementation of the <see cref="IContainerMemberAttribute"/> interface and can be used by all 
    ///     data storage and retrieval libraries when they need only the default properties.
    /// </remarks>
    [AttributeUsage(AttributeTargets.Property | AttributeTargets.Field, AllowMultiple = false, Inherited = true)]
    public class ContainerMemberAttribute : Attribute, IContainerMemberAttribute
    {
        /// <summary>
